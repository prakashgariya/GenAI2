(function () {
    ...
    class GenAIAssistant extends HTMLElement {
            ...
            sap.ui.define([
                ...
                return Controller.extend("MyController", {
                    onSendPressed: function (oEvent) {
                        ...
                        if (chatbot.fileIdForDeletion == 1){
                            var sendParameters = {"question":"Test","iteration":1,"fileDeletion":1, "assistantID":"Dummy"}
                            jQuery.ajax({
                                url: "https://genaiassistant-silly-bushbuck-ye.cfapps.us10.hana.ondemand.com",
                                cache: false,
                                type: "GET",
                        ...
                        // } 
                            ...
                            const API_URL = "https://genaiassistant-silly-bushbuck-ye.cfapps.us10.hana.ondemand.com"
